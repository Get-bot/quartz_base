---
title: 모던 자바 인 액션
description: 『모던 자바 인 액션』 5~9장 정리. 스트림 활용과 데이터 수집, 병렬 처리, 컬렉션 API, 람다 리팩터링.
date: 2026-09-14
---

2023년 12월부터 2024년 1월에 걸쳐 5~9장을 정리했습니다. 함수형 문법 자체보다 **언제 병렬 스트림이 오히려 느려지는가**(7장), **명령형 코드를 어디까지 스트림으로 바꿔야 가독성이 좋아지는가**(9장) 같은 판단 기준이 지금까지 남았습니다.
